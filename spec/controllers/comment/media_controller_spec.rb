...
RSpec.describe Comment::MediaController, type: :controller do
  ...
  describe 'POST create' do
    ...
    let(:invalid_attributes) do
      { text: '', permalink_slug: medium.permalinks.first.slug }
    end
  ...
  context 'PUT update' do
    context 'as an admin' do
      it_behaves_like 'updated medium comment request' do
      ...
      context 'with valid access' do
        ...
        context 'update another user medium comment' do
          ...
          it 'with valid attributes returns unauthorized' do
            put :update, params: { token: another_comment.token,
                                   text: 'new attributes',
